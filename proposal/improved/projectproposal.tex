...
\section{Dataset}
\textbf{HALLO KAN IEMAND HIER IETS TYPEN? :D}
...
\begin{center}
  \begin{tabular}{| l | p{5cm}| p{5cm} | r | }
	...
	20 & \begin{itemize} \vspace{-1.75em} \item Implement backpropagation \vspace{-1em}
	...
	21 &  \begin{itemize} \vspace{-1.75em} \item Start developing frontend/ backend architecture  \vspace{-1em}
	\item  lala check check lala
	\end{itemize}
	  & Finish backpropagation & 40 					\\	\hline
	22 & \begin{itemize} \vspace{-1.75em}
	\item In-between overall evaluation \vspace{-1em}
	\item Make a new planning which adjustments to implement \vspace{-1em}
	\item Experiment with preprocessed images (noise reduction) \vspace{-1em}
	\end{itemize} & Finish model with complete RGB values and the frontend/backend architecture must be completely thought over & 40 					\\  \hline
	23 & Start report writing and implement last adjustments & - & 40 	\\	\hline
